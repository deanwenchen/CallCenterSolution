...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/Claude/CallCenterSolution1/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=D:/Claude/CallCenterSolution1/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=D:/Claude/CallCenterSolution1/.claude/commands/gsd
AGENTS_DIR=D:/Claude/CallCenterSolution1/.claude/agents
```
...
<execution_context>
Surface state file: `D:/Claude/CallCenterSolution1/.claude/skills/.gsd-surface.json`
Install profile marker: `D:/Claude/CallCenterSolution1/.claude/skills/.gsd-profile`
Engine module: `D:/Claude/CallCenterSolution1/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/Claude/CallCenterSolution1/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>

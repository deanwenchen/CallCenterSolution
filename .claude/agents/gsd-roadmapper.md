...
Reference full template: `D:/Claude/CallCenterSolution1/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Claude/CallCenterSolution1/.claude/get-shit-done/templates/state.md`.

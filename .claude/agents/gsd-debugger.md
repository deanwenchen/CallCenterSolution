...
<required_reading>
@D:/Claude/CallCenterSolution1/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/Claude/CallCenterSolution1/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Claude/CallCenterSolution1/.claude
                  → checks D:/Claude/CallCenterSolution1/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Claude/CallCenterSolution1/.claude/get-shit-done
                  → writes to D:/Claude/CallCenterSolution1/.claude/get-shit-done/hooks/
...
@D:/Claude/CallCenterSolution1/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/Claude/CallCenterSolution1/.claude/get-shit-done/references/common-bug-patterns.md

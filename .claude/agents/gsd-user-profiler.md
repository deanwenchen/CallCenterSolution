...
<reference>
@D:/Claude/CallCenterSolution1/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Claude/CallCenterSolution1/.claude/get-shit-done/references/user-profiling.md` to load:

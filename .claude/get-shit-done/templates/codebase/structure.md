...
- Usage: Reference from command with `@D:/Claude/CallCenterSolution1/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Claude/CallCenterSolution1/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Claude/CallCenterSolution1/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

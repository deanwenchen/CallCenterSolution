...
```bash
INIT=$(node "D:/Claude/CallCenterSolution1/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/Claude/CallCenterSolution1/.claude/get-shit-done/templates/spec.md.

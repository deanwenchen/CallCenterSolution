...
Key references:
- @D:/Claude/CallCenterSolution1/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @D:/Claude/CallCenterSolution1/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Claude/CallCenterSolution1/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/Claude/CallCenterSolution1/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/Claude/CallCenterSolution1/.claude/get-shit-done/USER-PROFILE.md" "D:/Claude/CallCenterSolution1/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Claude/CallCenterSolution1/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Claude/CallCenterSolution1/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @D:/Claude/CallCenterSolution1/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/Claude/CallCenterSolution1/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/Claude/CallCenterSolution1/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Claude/CallCenterSolution1/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/Claude/CallCenterSolution1/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/Claude/CallCenterSolution1/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/Claude/CallCenterSolution1/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Claude/CallCenterSolution1/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/Claude/CallCenterSolution1/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/Claude/CallCenterSolution1/.claude/CLAUDE.md
```

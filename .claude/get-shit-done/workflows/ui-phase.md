...
```markdown
Read D:/Claude/CallCenterSolution1/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Claude/CallCenterSolution1/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Claude/CallCenterSolution1/.claude/agents/gsd-ui-checker.md for instructions.

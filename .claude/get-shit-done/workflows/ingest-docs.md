...
```bash
INIT=$(node "D:/Claude/CallCenterSolution1/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/Claude/CallCenterSolution1/.claude/get-shit-done/bin/gsd-tools.cjs" commit \

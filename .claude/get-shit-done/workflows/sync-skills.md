...
INSTALL_JS_GLOBAL="D:/Claude/CallCenterSolution1/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Claude/CallCenterSolution1/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.

...
<required_reading>
@D:/Claude/CallCenterSolution1/.claude/get-shit-done/references/ai-frameworks.md
@D:/Claude/CallCenterSolution1/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/Claude/CallCenterSolution1/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Claude/CallCenterSolution1/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Claude/CallCenterSolution1/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Claude/CallCenterSolution1/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Claude/CallCenterSolution1/.claude/agents/gsd-eval-planner.md for instructions.

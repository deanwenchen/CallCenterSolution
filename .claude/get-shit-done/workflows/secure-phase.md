...
```
Agent(
  prompt="Read D:/Claude/CallCenterSolution1/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Claude/CallCenterSolution1/.claude/get-shit-done/templates/SECURITY.md`

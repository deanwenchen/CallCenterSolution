...
```
Agent(
  prompt="Read D:/Claude/CallCenterSolution1/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Claude/CallCenterSolution1/.claude/get-shit-done/templates/VALIDATION.md`

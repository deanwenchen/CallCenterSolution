...
See D:/Claude/CallCenterSolution1/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using D:/Claude/CallCenterSolution1/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using D:/Claude/CallCenterSolution1/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from D:/Claude/CallCenterSolution1/.claude/get-shit-done/templates/discovery.md
...
Use D:/Claude/CallCenterSolution1/.claude/get-shit-done/templates/discovery.md.
